from LEGACY.setup.game_setup import GameSetup
from SERVER.setup.controller_factory import build_controller
from LEGACY.rendering.cli_renderer import CliRenderer
...
from LEGACY.gui.game_window import GameWindow
...
class Application:
    ...
    def run(self):
        ...
        controller = build_controller(board)
